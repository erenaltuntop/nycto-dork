...
# Örnek domain listesi (kısaltılmış)
domains = {'Default': ['com', 'fr', 'net', 'edu', 'gov', 'info']}
...
def get_sitearray():
    print("1 - Default")
    # Buraya diğer domain seçenekleri eklenebilir
    sitekey = input("\nChoose your target (if you don't know choose default): ")
    try:
...
# Basit search fonksiyonu örneği (geliştirilebilir)
def search(inurl, maxc):
    urls = []
    for site in sitearray:
        site = site.strip()
...
def menu():
    while True:
        ...
        choice = input(": ")
        if choice == '1':
            print("SQLi Testing seçildi (işlevi eklenmeli)")
            # injtest() fonksiyonunu çağırabilirsiniz
        elif choice == '2':
            print("LFI Testing seçildi (işlevi eklenmeli)")
            # lfitest() fonksiyonunu çağırabilirsiniz
        elif choice == '3':
            print("SQLi ve LFI Testing seçildi (işlevleri eklenmeli)")
            # injtest() ve lfitest() fonksiyonlarını çağırabilirsiniz
        elif choice == '4':
